...
class ArgumentParser(argparse.ArgumentParser):
    ...
    def format_help(self) -> str:
        ...
        # Determine what to display left and right for each argument,
        ...
        # define output template. Limit width of left part to a maximum of self.width / 2.
        # Use max() to prevent negative values. -4: two leading spaces (indent)
